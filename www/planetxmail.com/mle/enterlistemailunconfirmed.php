<table width="590" cellpadding="3" cellspacing="0" align="center" border="0">
  <tr>
    <td colspan="2" align="center">
      <p>You entered a <b>List Email Address</b> already and we sent a confirmation mail to that address.
      However, we haven't received a response yet.  If you feel you entered the
      List Address in error please <a href="main.php?option=enterlistemail"?>"><b>Click Here</b></a> to <i>reenter</i> the address.</p>
