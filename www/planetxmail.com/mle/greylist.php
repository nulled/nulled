<div style="width:600px;text-align:center">
  ...
  <div style="margin:5px auto; text-align:center;font-size:18px">
    Grey Listed Domains
  </div>
  ...
  <?php
    ...
    $h = substr(sha1('jsdfDIFJfjd86DFwj' . $_SESSION['aauserID'].$_SESSION['aalistname'].$_SESSION['aalistownerID']), 0, 5);
  ?>
  ...
  <div style="text-align: left">
    <ol>
      ...
      <li style="color:red">Once <i>All</i> steps completed, <a href="/mle/main.php?option=changesignupemail&h=<?=$h?>">Click Here</a> to try entering aim/aol.com as Contact Email.</li>
    </ol>
